...
int main(int argc, char* argv[]) 
{
    ...
    // Need to set the opponents race here for the prediction module, as the module itself cannot retrieve it
    // As far as we know
    bot.SetEnemyRace(std::to_string(Util::GetRaceFromString(enemyRaceString)));
